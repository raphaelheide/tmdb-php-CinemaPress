...
<div class="mx-auto "  style="width: 90%; ">
	 <div class="movie-heading" >
		...
		echo '<a href="../../' . $country . '/moviecredits/?' . $data['id'] . '/' . str_replace($search, $replace, $data['title']) . '"> <?php echo $andmore ?>...</a>';
		 echo '<br><a href="../../' . $country . '/moviecredits/?' . $data['id'] . '/' . str_replace($search, $replace, $data['title']) . '">→ <?php echo $allcast ?></a>'; ?>
